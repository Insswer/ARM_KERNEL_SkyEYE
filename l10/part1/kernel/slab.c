...
void *kmem_cache_alloc(struct kmem_cache *cache)
{
    ...
    cache->obj_block = (void *)(*(unsigned long *)p);
...
void init_kmem_cache(void)
{
    ...
    printf("kmemcache init OK...\n");
    printf("kmemcache objsize = %d, obj_num = %d, order = %d, start_page=0x%08x, obj_block point to 0x%08x",
                        kmem_cache.obj_size, kmem_cache.obj_num, kmem_cache.page_order, (unsigned long)kmem_cache.head_page,
                            (unsigned long)kmem_cache.obj_block);
}
